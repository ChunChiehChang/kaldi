...
if [ $stage -le 1 ]; then
  ...
  conv-layer name=conv1 height-in=224 height-out=224 time-offsets=-2,-1,0,1,2 required-time-offsets=0 height-offsets=-2,-1,0,1,2 num-filters-out=$nf1
  ...
  conv-layer name=conv7 height-in=112 height-out=56 height-subsample-out=2 time-offsets=-1,0,1 $common num-filters-out=$nf3
